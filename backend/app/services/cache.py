...
async def get_revenue_summary(
    ...
    When month+year are provided, the result is scoped to that month and the cache key
    includes them so different months for the same property do not collide.
    """
