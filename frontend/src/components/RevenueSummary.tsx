...
export const RevenueSummary: React.FC<RevenueSummaryProps> = ({ propertyId = 'prop-001', debugTenant, showRaw }) => {
    ...
    const numericTotal = typeof data.total_revenue === 'string' ? parseFloat(data.total_revenue) : data.total_revenue;
    const displayTotal = Math.round(numericTotal * 100) / 100;
