...
interface RevenueData {
    property_id: string;
    total_revenue: string; // Decimal string from backend — preserves cent-level precision
    currency: string;
...
export const RevenueSummary: React.FC<RevenueSummaryProps> = ({ propertyId = 'prop-001', debugTenant, showRaw }) => {
    ...
    // Parse the Decimal string returned by the API — already rounded to cents server-side
