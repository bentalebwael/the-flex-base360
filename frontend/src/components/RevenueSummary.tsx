...
interface RevenueData {
    ...
    // Do NOT parseFloat or Number() this value — that re-introduces the binary-float
    // drift Bug 2 was about. Format it as a string with the helper below.
...
/**
 * Format a NUMERIC(10,3) money string (e.g. "2250.000") for display without any
 * float arithmetic. Splits on the decimal point, inserts thousands separators into
 * the integer part via regex, and pads/truncates the fractional part to 3 digits.
 */
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
            ...
            <div className="p-6">
                ...
                {/*
                  The old "Precision Mismatch Detected" banner compared the raw float
                  against a two-decimal-rounded version of itself. It's removed because
                  the value is now a string; there is no float round-trip to mismatch.
                */}
            </div>
        </div>
    );
